...
var WordTo3Byte = function (u16word) {
  ...
  u8Byte3buf[2] = u16ByteLHbuf[1] >> 6  ;
  u8Byte3buf[0] = u16ByteLHbuf[0] & 0x7f;
  u16word = ( u16word << 1) & 0x7f00
  u16ByteLHbuf.writeUInt16LE(u16word, 0);
  u8Byte3buf[1] = u16ByteLHbuf[1]
...
console.log(u3ByteToWord(WordTo3Byte(data)));
initTest2();
